...
public class CourseController {
    ...
    @Autowired
    public CourseController(CourseService courseRepository, InstructorService instructorRepository, StudentService studentRepository, CompanyService companyRepository) {
