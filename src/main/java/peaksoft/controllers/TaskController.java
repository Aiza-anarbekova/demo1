...
public class TaskController {
    ...
    private final VideoService videoRepository;
@Autowired
    ...
    public String allTasks(@PathVariable Long id,
        ...
        model.addAttribute("task",taskRepository.getById(id));
        model.addAttribute("tasks",taskRepository.getTaskByLessonId(id));
